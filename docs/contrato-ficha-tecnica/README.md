...
| `ficha-tecnica.schema.json`          | El contrato **v1.2.0** como JSON Schema. **Generado** del Zod de la app (`pnpm contrato:ficha`); el test `ficha-tecnica-contrato` exige que coincidan.                                                                      |
